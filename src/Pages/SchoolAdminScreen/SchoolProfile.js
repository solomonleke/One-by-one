import { Avatar, Box, Flex, HStack, Menu, MenuButton, MenuItem, MenuList, Tab, TabIndicator, TabList, TabPanel, TabPanels, Tabs, Text, Image } from '@chakra-ui/react'
...
export default function SchoolProfile() {
  ...
  return (
    <Flex pos="sticky" top="0" bgColor={"white"} alignItems={"center"} justifyContent={"space-between"} zIndex={"10"} px="24px" py="15.6px" borderBottom={"1px solid #EDEFF2"}>
      ...
      <Box>
        <Image px="0px" py='4px' src={logo} width={"12%"} />
      </Box>
