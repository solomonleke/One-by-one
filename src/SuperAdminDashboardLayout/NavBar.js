        ...
        <Flex borderLeft="1px solid #EDEFF2" pos="sticky" top="0" bgColor={"white"} alignItems={"center"} justifyContent={"space-between"} zIndex={"10"} px="24px" py="15.6px" borderBottom={"1px solid #EDEFF2"}>
            ...
            <Tabs>
                <TabList color="#101828" pb="10px">
                    <Tab _selected={{ color: "green", fontWeight: "500" }} onClick={() => {
                        nav("/super-admin")
                    }}>Dashboard</Tab>
                    <Tab _selected={{ color: "green", fontWeight: "500" }} onClick={() => {
                    ...
                    <Tab _selected={{ color: "green", fontWeight: "500" }} onClick={() => {
                        nav("/super-admin-students")
                    }}>Students</Tab>
                    <Tab _selected={{ color: "green", fontWeight: "500" }} onClick={() => {
                        nav("/super-admin-scholarships")
                    }}>Scholarships</Tab>
                    <Tab _selected={{ color: "green", fontWeight: "500" }} onClick={() => {
                        nav("/super-admin-user-management")
                    }}>User Management</Tab>
                    <Tab _selected={{ color: "green", fontWeight: "500" }} onClick={() => {
                        nav("/super-admin-reports")
                    }}>Reports & Analytics</Tab>
                    <Tab _selected={{ color: "green", fontWeight: "500" }} onClick={() => {
                        nav("/super-admin-settings")
                    }}>Settings</Tab>
