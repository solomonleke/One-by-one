        ...
        >
            ...
            <Tabs>
                <TabList color="#101828" pb="10px">
                    <Tab _selected={{ color: "green", fontWeight: "500" }}>Dashboard</Tab>
                    <Tab _selected={{ color: "green", fontWeight: "500" }}>Schools</Tab>
                    <Tab _selected={{ color: "green", fontWeight: "500" }}>Students</Tab>
                    <Tab _selected={{ color: "green", fontWeight: "500" }}>
                        Scholarships
                    </Tab>
                    <Tab _selected={{ color: "green", fontWeight: "500" }}>
                        User Management
                    ...
                    <Tab _selected={{ color: "green", fontWeight: "500" }}>Settings</Tab>
                </TabList>
                                            ...
                                            >
                                                ...
                                                <Box>
                                                    <Text
                                                        ...
                                                        color={"#6B7280"}
                                                    >
                                                        Phillip Amakari’s student's profile has been
                                                        updated.
                                                    </Text>
                                                    <Text
                                                        fontSize={"12px"}
                        ...
                        <Menu isLazy>
                            <MenuButton as={Box}>
                                <HStack cursor={"pointer"}>
                                    ...
                                    />
                                    <Text color={"#2E2E2E"} fontWeight={"500"} fontSize={"14px"}>
                                        {userName} {lastName}
                                    </Text>
                            ...
                            <MenuList minWidth="232px">
                                ...
                                <MenuItem
                                    ...
                                    fontWeight={"400"}
                                    color="#586375"
                                    _hover={{ color: "green", fontWeight: "600", bg: "#E8FFF4" }}
                                >
