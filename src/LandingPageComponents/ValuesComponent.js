...
export default function Values() {
    return (
        <Box position="relative" overflow="hidden" align="center" bg="white" justifyContent="center" bgImage={greenBackground} bgPosition="center" bgRepeat="no-repeat" bgSize="cover" py={{ base: "100px", md: "135px" }} px={{ base: "50px", md: "120px", lg: "140px" }} >
